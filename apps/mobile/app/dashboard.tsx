            ...
            <View style={{ padding: 16 }}>
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 12, color: '#64748b', marginLeft: 4, marginRight: task.worker ? 6 : 0 }}>
                            {task.worker ? task.worker.name : 'Unassigned'}
                        </Text>
                        {task.worker && task.worker.rating !== undefined && (
                            <View style={{ backgroundColor: '#fef3c7', paddingHorizontal: 4, paddingVertical: 2, borderRadius: 4 }}>
                                <Text style={{ fontSize: 10, fontWeight: '700', color: '#d97706' }}>★ {task.worker.rating.toFixed(1)}</Text>
                            </View>
                        )}
                    </View>
                </View>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f8fafc' }}>
            ...
            >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                    <Text style={{ fontSize: 18, fontWeight: '700', color: '#0f172a' }}>
                        {user?.role?.toUpperCase() === 'CLIENT' ? 'Your Tasks' : 'Available Tasks'}
                    </Text>
                    <Text style={{ fontSize: 14, color: '#64748b' }}>
                ...
                {user?.role?.toUpperCase() === 'CLIENT' && (
                    ...
                    >
                        ...
                        <Text style={{ color: '#ffffff', fontSize: 16, fontWeight: 'bold' }}>Create New Task</Text>
                    </TouchableOpacity>
                )}
