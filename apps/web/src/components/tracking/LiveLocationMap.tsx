...
export const LiveLocationMap = ({
    ...
    if (loadError) {
        return (
            <div className="rounded-lg overflow-hidden border p-4 border-[var(--border-default)] bg-[var(--surface)]">
    ...
    if (!isLoaded) {
        return (
            <div className="rounded-lg overflow-hidden border border-[var(--border-default)]">
                <div className="w-full h-64 flex items-center justify-center bg-[var(--surface)]">
                    <div className="animate-pulse text-[var(--foreground-muted)]">Loading map...</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className={`${fullHeight ? 'h-full flex flex-col' : ''} rounded-lg overflow-hidden border border-[var(--border-default)]`}>
            {/* Map Container */}
