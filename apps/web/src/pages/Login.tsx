            ...
            <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex items-center space-x-2 pt-1">
                    <input
                        ...
                        className="w-4 h-4 rounded border border-[var(--border-default)] bg-[var(--background-elevated)] text-[var(--accent)] focus:ring-[var(--accent)] focus:ring-offset-0 transition-colors cursor-pointer"
                    />
                    <label htmlFor="terms" className="text-sm cursor-pointer text-[var(--foreground-muted)]">
                        Remember me
                    </label>
                </div>
                ...
                <p className="text-center text-sm pt-4 text-[var(--foreground-muted)]">
                    ...
                    <Link to="/register" className="font-semibold transition-colors text-[var(--accent)] hover:text-[var(--accent-bright)]">
                        Sign up
                    </Link>
                </p>
            </form>
